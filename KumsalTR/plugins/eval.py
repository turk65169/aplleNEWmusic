...
from KumsalTR import anon, app, config, db, lang, userbot
from KumsalTR.helpers import format_exception, meval


@app.on_message(filters.command(["eval", "geri"]) & filters.user(app.owner))
